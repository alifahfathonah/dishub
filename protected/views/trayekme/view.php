...
for($i=0;$i<$jml;$i++){ 
 ...
 ?></td>
  ...
  <tr class="odd">
    ...
    <td><?php if($model->jnstrayek_id==2){echo $model->awal_id;}else{ echo CHtml::encode(Terminal::model()->findByPk($model->awal_id)->nama);}?></td>
  ...
  <tr class="even">
    ...
    <td><?php if($model->jnstrayek_id==2){echo $model->akhir_id;}else{echo CHtml::encode(Terminal::model()->findByPk($model->akhir_id)->nama);}?></td>

...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'gruptrayek_id'); ?>
		<?php echo $form->textField($model,'gruptrayek_id',array('size'=>6,'maxlength'=>6)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'jnslayantrayek_id'); ?>
	</div>

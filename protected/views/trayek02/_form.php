...
<?php 
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'awal_id',array('size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'awal_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'akhir_id'); ?>
		<?php echo $form->textField($model,'akhir_id',array('size'=>60,'maxlength'=>100)); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'tarifbawah'); ?>
		<?php echo $form->error($model,'tarifbawah'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'tarifatas'); ?>
		<?php echo $form->textField($model,'tarifatas'); ?>

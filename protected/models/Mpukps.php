...
/**
 * This is the model class for table "mpukps".
 *
 * The followings are the available columns in table 'mpukps':
 * @property integer $id
 ...
 */
class Mpukps extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Mpukps the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('alamat, jenisijinp2t, ketp2t', 'length', 'max'=>100),
			array('kodetra', 'length', 'max'=>6),
			array('jumlahken, kaporg', 'length', 'max'=>3),
			array('sifatpel', 'length', 'max'=>20),
			array('nopol, nouji, merk, nokwi, retribusi, pelunasan', 'length', 'max'=>15),
			...
			array('id, nokps, mb_srtkps1, mb_srtkps2, kodedk, nosrtp2t, nama, npwp, noinduk, alamat, kodewil, jenisijinp2t, kodetra, jumlahken, sifatpel, mb_srtp2t1, mb_srtp2t2, tglterbitp2t, ketp2t, nosrtpit, tglditetapkanpit, nopol, nouji, mb_uji1, mb_uji2, merk, thnken, kaporg, kapbrg, idpjbtprop, nokwi, retribusi, pelunasan, tglentry, kodeuser, statusdata, statuscetak', 'safe', 'on'=>'search'),
		);
	}
